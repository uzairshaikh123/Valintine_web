              ...
              <Box style={{ overflowY: "auto", marginTop: "20px" }}>
                <form action="">
                  ...
                  <select id="category">
                    ...
                    <option value="anniversarycelebrations">Anniversary Celebrations</option>
                  ...
                  <select id="subcategory">
                          ...
                          <option value="Rasmalai Cakes">Rasmalai Cakes</option>
                          ...
                          <option value="Mango Cakes">Mango Cakes</option>
                          ...
                          <option value="Sympathy N Funeral">Sympathy N Funeral</option>
                          <option value="Sunflower">Sunflower</option>
                          <option value="Private Candlelight Dinners">Private Candlelight Dinners</option>
                          <option value="Cabana Setup">Cabana Setup</option>
                          <option value="Outdoor Dinners">Outdoor Dinners</option>
