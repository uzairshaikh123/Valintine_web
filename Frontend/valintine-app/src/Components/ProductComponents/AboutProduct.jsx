...
<h3>Why ❤️ ValintineSaga ?</h3>
        <ul style={{padding:"25px"}}>
          ...
          <li style={{textAlign:"start",marginBottom:"10px"}}>👍 Complete Confidence - Browse all Verified Reviews and Original Photographs</li>
          <li style={{textAlign:"start",marginBottom:"10px"}}>👍 100% Refund - In case of non-availability, a complete refund of total amount is initiated</li>
        </ul>
